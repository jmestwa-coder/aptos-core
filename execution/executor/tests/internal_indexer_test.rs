...
fn test_db_indexer_data() {
    ...
    let expected_code = vec![
        ...
        ident_str!("confidential_asset"),
        ident_str!("account_abstraction"),
        ident_str!("confidential_amount"),
        ...
        ident_str!("sigma_protocol_utils"),
        ...
        ident_str!("sigma_protocol_witness"),
        ...
        ident_str!("sigma_protocol_statement"),
        ident_str!("solana_derivable_account"),
        ident_str!("validator_consensus_info"),
        ident_str!("confidential_range_proofs"),
        ident_str!("ristretto255_bulletproofs"),
        ident_str!("ethereum_derivable_account"),
        ident_str!("sigma_protocol_fiat_shamir"),
        ident_str!("dispatchable_fungible_asset"),
        ident_str!("sigma_protocol_homomorphism"),
        ident_str!("sigma_protocol_key_rotation"),
        ident_str!("sigma_protocol_registration"),
        ident_str!("sigma_protocol_representation"),
        ident_str!("sigma_protocol_statement_builder"),
        ident_str!("common_account_abstractions_utils"),
        ident_str!("sigma_protocol_representation_vec"),
    ]
    .into_iter()
    ...
    let expected_resources = vec![
        ...
        (false, "0x1::confidential_asset::GlobalConfig"),
