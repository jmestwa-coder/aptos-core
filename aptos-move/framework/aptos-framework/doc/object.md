...
-  [Function `create_named_onchain_signer`](#0x1_object_create_named_onchain_signer)
...
<a id="0x1_object_create_named_onchain_signer"></a>

## Function `create_named_onchain_signer`
...
Use <code>owned_by_creator</code> if you want object to be owned by creator.
Note that if object is owned by creator, then creator still can do thing directly to the object,
for example withdraw from fungible stores signer would own.


<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_create_named_onchain_signer">create_named_onchain_signer</a>(creator: &<a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, name: <a href="../../aptos-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;, owned_by_creator: bool): <a href="object.md#0x1_object_ExtendRef">object::ExtendRef</a>
</code></pre>
...
<pre><code><b>public</b> <b>fun</b> <a href="object.md#0x1_object_create_named_onchain_signer">create_named_onchain_signer</a>(
    creator: &<a href="../../aptos-stdlib/../move-stdlib/doc/signer.md#0x1_signer">signer</a>, name: <a href="../../aptos-stdlib/../move-stdlib/doc/vector.md#0x1_vector">vector</a>&lt;u8&gt;, owned_by_creator: bool
    ...
    <b>if</b> (!owned_by_creator) {
        constructor_ref.<a href="object.md#0x1_object_transfer_with_constructor_ref">transfer_with_constructor_ref</a>(extend_ref.self);
    };
    extend_ref
}
</code></pre>
